...
1. wget -c http://kent.dl.sourceforge.net/sourceforge/witty/wt-3.3.2.tar.gz
2. tar xvxf wt-3.3.2.tar.gz
3. cd wt-3.3.2
4. mkdir buildtrik
5. cd buildtrik
6. source /opt/trik-sdk/environment-setup-armv5te-oe-linux-gnueabi
...
7. cmake .. -DSHARED_LIBS=OFF -DBOOST_PREFIX=/opt/trik-sdk/sysroots/armv5te-oe-linux-gnueabi/usr/ -DWT_CPP_11_MODE=-std=c++0x -DWT_SIGNALS_IMPLEMENTATION=boost.signals2 -DENABLE_SQLITE=OFF -DENABLE_POSTGRES=OFF
